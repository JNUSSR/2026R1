...
// 遥控参数
#define RC_BASE_LINEAR_SPEED    5.0f   // 摇杆推满时底盘基准线速度 (m/s)
...
#define RC_TO_VW_SCALE         0.1f   // 旋转角速度比例
#define RC_DEADBAND            10.0f  // 右摇杆平移死区 (%)
#define RC_ROTATION_DEADBAND   10.0f   // 左摇杆旋转死区 (%)
